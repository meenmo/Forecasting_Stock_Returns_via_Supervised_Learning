...
% \begin{figure}[h]
%   \includegraphics[height=2.5cm, width=7cm]{Plots/Figure2.png}
%   \caption{Figure 2: TimeSeriesSplit for Parameter Tuning \& Forecasting}
% \end{figure}
...
% \myfigure{L}{.5\linewidth}{\linewidth}{Plots/Comparison.png}{Figure 3: Selecting the Total Number of Estimators for each Ensemble Method}

\begin{figure}[h]
\begin{center}
  \includegraphics[height=5.5cm, width=6.5cm]{Plots/Comparison.png}
  \caption{Figure 2: Selecting the Total Number of Estimators for each Ensemble Method}
\end{center}
\end{figure}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Environment: JupyterLab, Visual Studio Code
    \end{itemize}
    \item GitHub Link : \href{https://github.com/meenmo/Forecasting_Stock_Returns_via_Supervised_Learning}{ \underline{Forecasting Stock Returns}}
\end{itemize}
...
\bottomrule
\end{tabular}}
\caption*{Figure 4: Optimal Hyper-parametersof Each Model}
\end{table}
\begin{figure*}
  \includegraphics[width=\textwidth,height=6.7 cm]{Plots/RF_Predicted_Returns_Actual_Returns.png}
  \caption{Figure 5: Forecasted Returns with Boosting}
\end{figure*}
...
\begin{figure}[h]
\begin{center}
  \includegraphics[height=8cm, width=8cm]{Plots/ConfusionMatrix.png}
  \caption{Figure 7: Confusion Matrices for Binary Prediction}
\end{center}
\end{figure}
...
\bottomrule
\end{tabular}}
\caption*{Figure 8: Binary Prediction Accuracy}
\end{table}
...
{\bf Meenmo Kang (Data Wizard)}: Was primarily responsible for data cleaning and data visualization. Meenmo focused on identifying potential outliers to exclude from our analysis. Furthermore, feature engineering from base dataset was done by Meenmo and Jonathan.

{\bf Jonathan Santoso (Model Ninja)}: Created lagged stock return features, helped in the selection of machine learning algorithms, and hyper-parameter tuning via grid-search. Moreover, Jonathan was involved in determining cross-validation splits and interpreting results.
...
\section{Work Cited}
\begin{enumerate}
    \item GitHub URL - Contains all data \& code used in our analysis\\ \url{https://github.com/meenmo/Forecasting_Stock_Returns_via_Supervised_Learning} 
